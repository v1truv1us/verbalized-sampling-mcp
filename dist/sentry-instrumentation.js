...
export class SentryMcpInstrumentation {
     ...
     */
    trackTransportInit(transportType) {
        return Sentry.startSpan({
     ...
     */
    trackVSToolExecution(toolName, strategy, prompt) {
        ...
        this.activeSpans.set(`${toolName}-${strategy}`, { span: {}, prompt });
    }
    /**
     * Complete tool execution with metrics
     */
    completeVSToolExecution(toolName, strategy, result, executionTime, error) {
     ...
     */
    trackMcpOperation(operation, details) {
        Sentry.addBreadcrumb({
     ...
     */
    trackClientConnection(clientType) {
...
//# sourceMappingURL=sentry-instrumentation.js.map